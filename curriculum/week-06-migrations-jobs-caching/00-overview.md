...
| [resources.md](./01-resources.md) | Django migrations, Celery 5.x, Redis 7 — the references worth bookmarking |
| [lecture-notes/01-real-world-migrations.md](./02-lecture-notes/01-real-world-migrations.md) | Non-null columns, renames, data migrations, reversibility, the deployment ordering |
| [lecture-notes/02-celery-broker-worker-beat.md](./02-lecture-notes/02-celery-broker-worker-beat.md) | Celery architecture, your first task, retries, idempotency, beat |
| [lecture-notes/03-redis-caching-patterns.md](./02-lecture-notes/03-redis-caching-patterns.md) | Cache-aside, per-view and per-fragment, invalidation, stampedes |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-data-migration.md](./03-exercises/exercise-01-data-migration.md) | Backfill a computed column on `crunchwriter` with `RunPython` |
| [exercises/exercise-02-first-celery-task.md](./03-exercises/exercise-02-first-celery-task.md) | Wire Celery, send your first task, watch it run, write a retry |
| [exercises/exercise-03-cache-aside.md](./03-exercises/exercise-03-cache-aside.md) | Cache the analytics dashboard panels, invalidate on save, measure the win |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenge |
| [challenges/challenge-01-image-thumbnails-async.md](./04-challenges/challenge-01-image-thumbnails-async.md) | Generate three sizes asynchronously, with retries and idempotency |
| [quiz.md](./05-quiz.md) | 10 MCQ |
| [homework.md](./06-homework.md) | Six problems (~6h) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Image upload + async thumbnail generation in `crunchwriter` |
