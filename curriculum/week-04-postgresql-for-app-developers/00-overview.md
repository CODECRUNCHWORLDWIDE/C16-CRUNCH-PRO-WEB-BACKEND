...
| [resources.md](./01-resources.md) | Postgres 16 docs + the three external references that pay for themselves |
| [lecture-notes/01-psql-schema-and-indexes.md](./02-lecture-notes/01-psql-schema-and-indexes.md) | `psql`, schema design, B-tree / GIN / partial / expression indexes |
| [lecture-notes/02-explain-analyze-and-the-query-planner.md](./02-lecture-notes/02-explain-analyze-and-the-query-planner.md) | Reading plans, the cost model, the four shapes of "slow" |
| [lecture-notes/03-transactions-isolation-jsonb-fts.md](./02-lecture-notes/03-transactions-isolation-jsonb-fts.md) | Transactions, isolation levels, JSONB, full-text search |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-create-and-populate.md](./03-exercises/exercise-01-create-and-populate.md) | A schema from scratch, 100 k rows, `\copy`, indexes on purpose |
| [exercises/exercise-02-explain-a-slow-query.md](./03-exercises/exercise-02-explain-a-slow-query.md) | Read three plans, name the bottleneck, propose the fix |
| [exercises/exercise-03-add-an-index-measure-the-win.md](./03-exercises/exercise-03-add-an-index-measure-the-win.md) | Add the right index. Measure before and after. Defend the choice. |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenges |
| [challenges/challenge-01-jsonb-vs-real-columns.md](./04-challenges/challenge-01-jsonb-vs-real-columns.md) | Same workload, two schemas, which one earns its keep |
| [quiz.md](./05-quiz.md) | 10 MCQ |
| [homework.md](./06-homework.md) | Six problems (~6h) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Profile, fix, measure: one real `crunchwriter` query, end to end |
